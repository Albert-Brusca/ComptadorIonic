    ...
    async info() {
      const alert = await alertController
          .create({
            ...
            subHeader: 'Creat per Albert Brusca',
            message: 'Codi font a: <a href="https://github.com/Albert-Brusca/ComptadorIonic">https://github.com/Albert-Brusca/ComptadorIonic</a>',
            buttons: ['OK'],
          });
      await alert.present();
    },
